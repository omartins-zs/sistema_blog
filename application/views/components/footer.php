 ...
 <style>
   /* ===== GLOBAL OVERRIDES (Light & Dark) ===== */
   .blog-entry { border-radius: 12px; overflow: hidden; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.05); transition: transform 0.2s, box-shadow 0.2s; padding: 1.5rem !important; align-items: center; border: 1px solid #f0f0f0; background: #fff; }
   .blog-entry:hover { transform: translateY(-5px); box-shadow: 0 12px 20px rgba(0, 0, 0, 0.1); }
   .blog-entry .img { min-width: 130px !important; width: 130px !important; height: 130px !important; margin-right: 1.5rem; border-radius: 50% !important; }
   .blog-entry .text { padding: 0 !important; }
   @media (max-width: 768px) {
       .blog-entry { flex-direction: column; text-align: center; }
       .blog-entry .img { margin: 0 auto 1.5rem auto !important; }
   }
   ...
   /* Blog Entries (Dark) */
   body.dark-mode .blog-entry { background:#1F2937 !important; border: 1px solid #374151 !important; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.3); }
   body.dark-mode .blog-entry:hover { box-shadow: 0 12px 20px rgba(0, 0, 0, 0.4); }
